...
<div className="app__specialMenu-tittle">
  <SubHeading tittle="Delicious Menu "/>
...
<div className="app__specialMenu-menu">
  <div className="app__specialMenu-menu_wine flex__center">
    <p className="app__specialMenu-menu_heading">Wine & Beer</p>
      <div className="app_specialMenu_ menu_items">
 ...
 <div className="app_specialMenu_ menu_items">
  {data.cocktails.map((cocktials,index)=>(
    <MenuItem key ={cocktials.title + index} title={cocktials.title}  price={cocktials.price} tag={cocktials.tags } />
  )
  )}
 </div>
  </div>
